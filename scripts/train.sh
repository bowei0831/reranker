...
###
export WANDB_RUN_NAME="base-reranker-bge_library"
###
JOB_NAME=base-reranker
...
# 核心超參數
TRAIN_GROUP_SIZE=16          # 1 pos + 15 neg（與資料格式匹配）
QUERY_MAX_LEN=64            # Query 長度（BGE 官方用 256）
OUTPUT_DIR="/home/peter831/test/outputs2/base_bge_add_library"
PASSAGE_MAX_LEN=440          # Passage 長度
LEARNING_RATE=5e-6           # 學習率（reranker 通常較小）
