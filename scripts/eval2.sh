...
COMMAND="source ~/miniconda3/etc/profile.d/conda.sh && conda activate test && export PYTORCH_CUDA_ALLOC_CONF=expandable_segments:True && python /home/peter831/test/scripts/eval_cmteb.sh"
